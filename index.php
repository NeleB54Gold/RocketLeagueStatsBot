...
require_once('RocketLeagueTracker.php');
...
if (!$NeleBotX->response['ok']) {
	if ($NeleBotX->response['error_code'] != 429 && isset($bot)) $bot->sendLog($bot->bold('The Bot was stopped!') . PHP_EOL . $bot->code($NeleBotX->response['description'], 1));
